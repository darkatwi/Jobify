...
{
    /// <inheritdoc />
    public partial class AddSavedOpportunities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpportunityReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OpportunityReports_Opportunities_OpportunityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpportunityReports_OpportunityId_ReporterUserId_Reason",
                table: "OpportunityReports",
                columns: new[] { "OpportunityId", "ReporterUserId", "Reason" });
